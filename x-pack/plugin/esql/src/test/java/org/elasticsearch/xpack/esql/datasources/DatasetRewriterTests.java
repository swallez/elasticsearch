...
public class DatasetRewriterTests extends ESTestCase {
    ...
    public void testMixedDatasetsAndNonDatasetsProducesUnionAll() {
        ...
        LogicalPlan rewritten = DatasetRewriter.rewrite(relationOf("some_idx,logs"), project, RESOLVER);
    ...
    public void testMixedMultipleIndicesAndDatasetsProducesUnionAll() {
        ...
        LogicalPlan rewritten = DatasetRewriter.rewrite(relationOf("idx1,idx2,ds1,ds2"), project, RESOLVER);
    ...
    public void testClosedIndexCountsAsNonDatasetInHeterogeneousUnionAll() {
        ...
        LogicalPlan rewritten = DatasetRewriter.rewrite(relationOf("my_closed_index,logs"), project, RESOLVER);
